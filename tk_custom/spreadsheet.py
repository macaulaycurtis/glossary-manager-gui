...
class Spreadsheet(tk.Frame):
    ...
    def context_menu(self, event):
        ...
        self.cell_x = event.x_root - self.tree.winfo_rootx() # Identify the coordinates of the event relative to the treeview 
        ...
        if self.tree.identify_region(self.cell_x, self.cell_y) == 'cell':
            ...
            self.cell_context_menu.tk_popup(event.x_root + 35, event.y_root +15, entry="0")
    ...
    def edit(self, event=None):
        ...
        self.cell_popup.bind('<Button-3>', context_popup)
        self.root.bind('<Button>', click_off)
        self.root.bind('<Escape>', escape_popup)
